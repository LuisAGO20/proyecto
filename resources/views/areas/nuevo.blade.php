<x-app-layout>
    <br>
        <h2><span class="badge bg-secondary">Complete el Formulario para Registrar un nuevo Departamento</span></h2>
    <br>
    <div class="card">
        <div class="card-body">
            ...
            <form method="POST" action="{{ route('guardarArea') }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="encargado" name="encargado" value="{{old('encargado')}}" aria-describedby="emailHelp">
